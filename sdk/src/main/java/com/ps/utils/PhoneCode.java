...
public class PhoneCode {
    ...
    class StaticPeram {
        ...
        // 替换成你的AK (产品密)
        final static String accessKeyId = "LTAIgCakh8hyucDW";// 你的accessKeyId,填你自己的 上文配置所得  自行配置
        final static String accessKeySecret = "BFFw2MZyRZ9poytOubtOGZEq3fM0VD";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置
        // 必填:短信签名-可在短信控制台中找到
        final static String SignName = "深圳磐石教育"; // 阿里云配置你自己的短信签名填入
        // 必填:短信模板-可在短信控制台中找到
        final static String TemplateCode = "SMS_167960827"; // 阿里云配置你自己的短信模板填入
    }


    public static String send(String phone) {
        return getPhonemsg(phone);
    }
     ...
     * @return
     */
    private static String getPhonemsg(String mobile) {
